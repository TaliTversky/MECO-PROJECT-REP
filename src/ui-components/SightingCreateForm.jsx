...
export default function SightingCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setSpeciesCommonName(initialValues.speciesCommonName);
    setSpeciesScienceName(initialValues.speciesScienceName);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createSighting.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "SightingCreateForm")}
      {...rest}
    >
      <TextField
        label="Date"
